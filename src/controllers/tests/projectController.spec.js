...
import usuarioController from "../usuarioController.ts"; // Adicione o .js no final
import usuarioModel from "../../models/usuarioModel.ts"; // Adicione o .js no final

//const usuarioController = require('../usuarioController');
//const usuarioModel = require('../../models/usuarioModel');
// Mock do modelo para evitar que o Jest tente ler o banco de dados real
jest.mock('../../models/usuarioModel.ts'); 
